...
import { navbtn, navbtnout,colors } from '../globals/style';
...
const UserCart = ({ navigation }) => {
    ...
    const deleteItem =(item)=>{
        const docRef = firebase.firestore().collection("UserCart").doc(firebase.auth().currentUser.uid);
        docRef.update({cart:firebase.firestore.FieldValue.arrayRemove(item)})
        getCartData();
       alert("item deleted")
    }
  return (
                            ...
                            <View style={styles.cartcard}>
                             ...
                             <View style={styles.cartcardin}>
                                ...
                                <View style={styles.c4} >
                                    <Text style={styles.txt1} onPress={()=>deleteItem(item)} > Delete</Text>
                                  <DeleteIcon  size={24} name="delete"  />
                                </View>
                             </View>
                            </View>
